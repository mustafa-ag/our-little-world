...
export const HERO_ASSETS = {
  ...
  bench: { url: glb("bench"), build: buildBench, source: "blender", shadow: false },
  "lamp-post": { url: glb("lamp-post"), build: buildLampPost, source: "blender" },
  signpost: { url: glb("signpost"), build: buildSignpost, source: "blender", shadow: false },
  ...
  barrel: { url: glb("barrel"), build: buildBarrel, source: "blender", shadow: false },
  crate: { url: glb("crate"), build: buildCrate, source: "blender", shadow: false },
