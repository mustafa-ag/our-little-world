...
export const BABA_SHOPPING_STORES: ShoppingStoreDef[] = [
  ...
  },
  {
    ...
    subtitle: "Stories · journals · one suspiciously heavy bag",
    side: "left",
    floor: 1,
    y: 2950,
    color: 0x6d4c41,
    ...
    bagLabel: "READ",
    products: [
      { id: "book_romcom", name: "Mall rom-com stack", description: "Research material. Moomoo is unconvinced.", stress: 5, icon: "▤", rewardType: "item", rewardId: "mall_romcom_stack" },
      { id: "book_journal", name: "Gold-edge journal", description: "For documenting entirely sensible purchases.", stress: 4, icon: "▥", rewardType: "keepsake", rewardId: "gold_edge_journal" },
      { id: "book_cookbook", name: "Tiny feast cookbook", description: "Optimistic evidence that dinner may happen.", stress: 6, icon: "▦", rewardType: "item", rewardId: "tiny_feast_cookbook" },
    ],
  },
  {
    id: "cartier",
  ...
  },
  {
    id: "tech",
    name: "CHARGE & CHAOS",
    subtitle: "Headphones · camera · devices Baba can price-check",
    side: "left",
    floor: 2,
    y: 6700,
    color: 0x3f607d,
    ...
    bagLabel: "TECH",
    products: [
      { id: "tech_headphones", name: "Cloud headphones", description: "Noise cancellation for budget discussions.", stress: 8, icon: "◉", rewardType: "item", rewardId: "cloud_headphones" },
      { id: "tech_camera", name: "Pocket camera", description: "For photographing the evidence beautifully.", stress: 12, icon: "▣", rewardType: "keepsake", rewardId: "pocket_camera" },
      { id: "tech_charger", name: "Heart power bank", description: "Practical, pink, and only slightly overpriced.", stress: 6, icon: "↯", rewardType: "item", rewardId: "heart_power_bank" },
    ],
  },
  {
    id: "lingerie",
  ...
  },
  {
    id: "home_decor",
    name: "NEST & NONSENSE",
    subtitle: "Decor · cushions · things that require another shelf",
    side: "left",
    floor: 3,
    y: 10500,
    color: 0x7d8060,
    ...
    bagLabel: "NEST",
    products: [
      { id: "decor_cushion", name: "Ridiculous cushion", description: "Looks like a cloud. Occupies an entire bag.", stress: 5, icon: "▱", rewardType: "keepsake", rewardId: "ridiculous_cushion" },
      { id: "decor_vase", name: "Sunset vase", description: "Fragile, dramatic, and now Moomoo's problem.", stress: 8, icon: "♢", rewardType: "item", rewardId: "sunset_vase" },
      { id: "decor_lantern", name: "Warm little lantern", description: "Makes every room look like a date scene.", stress: 7, icon: "✦", rewardType: "keepsake", rewardId: "mall_lantern" },
    ],
  },
  {
    id: "home_hugs",
  ...
  },
  {
    id: "cafe_box",
    name: "ONE LAST CAFÉ",
    subtitle: "Coffee · cake · the lie contained in 'last'",
    side: "left",
    floor: 4,
    y: 15100,
    color: 0x8b6047,
    ...
    bonus: true,
    products: [
      { id: "cafe_coffee", name: "Victory iced coffee", description: "Necessary fuel for the final six hundred metres.", stress: 4, icon: "☕", rewardType: "item", rewardId: "victory_iced_coffee" },
      { id: "cafe_cake", name: "Celebration cake box", description: "Too large. Completely correct.", stress: 7, icon: "▰", rewardType: "item", rewardId: "celebration_cake_box" },
      { id: "cafe_mug", name: "Mall survivor mug", description: "Proof that this became an endurance sport.", stress: 5, icon: "□", rewardType: "keepsake", rewardId: "mall_survivor_mug" },
    ],
  },
];
