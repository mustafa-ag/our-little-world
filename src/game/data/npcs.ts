...
export const NPCS: NpcDef[] = [
  ...
  {
    id: "adnoc_recruiter",
    name: "Alya at ADNOC HQ",
    colors: baseColors({ hair: "#2b1d16", hairShade: "#17100b", skin: "#e6b58c", skinShade: "#cf9a70", top: "#2f6fd0", topShade: "#22539f", bottom: "#2a334d" }),
    location: "abudhabi_city",
    tx: 94,
    ty: 32,
    facing: "down",
    dialogue: ["HQ is all blue glass, sample reports, and people who know where the good karak is.", "The petrol station is excellent, but it is not your office."],
  },
  // Mall regulars are only placed by MallScene, never on an exterior map.
  {
    id: "fashion_assistant",
    name: "Fashion Assistant",
    colors: baseColors({ hair: "#7b4f35", hairShade: "#573521", skin: "#f0c49a", skinShade: "#daa87c", top: "#f28ab2", topShade: "#d96e98", bottom: "#3d5a80" }),
    location: "mall",
    tx: 0,
    ty: 0,
    dialogue: ["Fashion emergency. Obviously.", "Another bag? I support this."],
  },
  {
    id: "jewelry_assistant",
    name: "Jewelry Assistant",
    colors: baseColors({ hair: "#2f2a3d", hairShade: "#1d1928", skin: "#d9a679", skinShade: "#c08d60", top: "#f4c95d", topShade: "#d4a83a", bottom: "#3a2b3a" }),
    location: "mall",
    tx: 0,
    ty: 0,
    dialogue: ["Sparkles are medically important.", "Your card is still working. Remarkable."],
  },
  {
    id: "mall_concierge",
    name: "Mall Concierge",
    colors: baseColors({ hair: "#33312e", hairShade: "#1f1d1b", skin: "#e6b58c", skinShade: "#cf9a70", top: "#5c8ce2", topShade: "#456fc0", bottom: "#2a334d" }),
    location: "mall",
    tx: 0,
    ty: 0,
    dialogue: ["Welcome! The cafe is to your left. The temptation is everywhere.", "Please enjoy your very normal amount of shopping."],
  },
  {
    id: "mall_cafe_worker",
    name: "Cafe Worker",
    colors: baseColors({ hair: "#5a382c", hairShade: "#382116", skin: "#f2d3b0", skinShade: "#dab48f", top: "#7be0a3", topShade: "#57bf82", bottom: "#333a45" }),
    location: "mall",
    tx: 0,
    ty: 0,
    dialogue: ["Coffee first, bags second. Or both.", "I saw nothing. I charged nothing."],
  },
];
