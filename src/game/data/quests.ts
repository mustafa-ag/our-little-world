...
export const QUESTS: QuestDef[] = [
  ...
  },
  {
    ...
    giver: "mama",
    requiresQuests: ["q_baba_spree", "q_edinburgh"],
    intro: "Grandma's jewelry and my bangle are with Fadwa. Please do not get any ideas, habibti.",
    steps: [
      { type: "interact", target: "pirate_idea", hint: "Have a completely normal idea" },
      { type: "visit", target: "edinburgh", hint: "Sail to Edinburgh in disguise" },
      { type: "interact", target: "sister_room", hint: "Find Fadwa's Edinburgh room" },
      { type: "playMinigame", target: "family_safe", hint: "Open Grandma's secret safe" },
      { type: "interact", target: "escape_sister_room", hint: "Escape Fadwa's room" },
    ],
    complete: "Absolutely no crimes occurred. Mama's bangle is sparkling, Grandma's jewelry is safe, and that mustache is staying in the drawer.",
    rewardHearts: 6,
    rewardCoins: 30,
    rewardNpc: "fadwa",
    rewardRel: 12,
